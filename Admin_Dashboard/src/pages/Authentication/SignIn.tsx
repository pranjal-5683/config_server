...
const SignIn = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (!valid) {
      return (document.getElementById('passspan').innerHTML =
        '<span><mark> Password must be at 8 to 16 characters long and contain at least oneuppercase letter, one lowercase letter, one number, and one special character.</mark></span>');
    } else {
      fetch('http://localhost:5000/login', {
        ...
        .then((data) => {
          ...
          if (data.status === 'ok') {
            ...
            sweetAlert.fire('Login Success', '', 'success');
            navigate('/');
          } else {
            sweetAlert.fire('Login Failed...', '', 'error');
          }
        });
    }
  };
  ...
  const handlePasswordChange = (e: React.FormEvent<HTMLInputElement>) => {
    ...
    const maxlengthRequirement = newPassword.length < 17;
    ...
    // setMaxlength(maxlengthRequirement);
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <span
                      ...
                      className="absolute right-1 top-15 text-[#dc2626] "
                    >
                      Email must be as <b>xyz@gmail.com</b> format
                    </span>
                    {status ? (
                      <span className="absolute right-1 top-15 text-[#dc2626]">
                        {status}
                      </span>
                    ) : (
                      ''
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <span
                      ...
                      className="absolute right-1 top-15 text-[#dc2626]"
                    >
                      Password must be at 8 to 16 characters long and contain at
                      least one uppercase letter, one lowercase letter, one
                      number, and one special character.
                    </span>
                    {/* {!maxlength? <span className="absolute right-1 top-15 text-[#dc2626]">maxlength is only 16 Char</span>:''} */}
                    ...
                    >
                      {flag ? (
                        <img
                          src="https://www.pngitem.com/pimgs/m/600-6000108_modify-the-password-small-eyes-eye-password-png.png"
                          width="22"
                          height="22"
                        />
                      ) : (
                        <img
                          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuuSKxQJR0WVeIcojTfXtjd8VJ4-LtJpebFWJoc01cH0B1lh2GIginvgjmqU1DkpJdCyU&usqp=CAU"
                          width="22"
                          height="22"
                        />
                      )}
