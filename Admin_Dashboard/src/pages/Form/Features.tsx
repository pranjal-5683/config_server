...
const Features = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await axios
      .post('http://localhost:5000/featuresadd', formData, {
        headers: {
      ...
      .then((response) => {
        ...
        if (response.statusText === 'OK') {
          sweetAlert.fire('Features Added Successully', '', 'success');
          getSelectData();
          setTitle('');
          setDescription('');
        } else {
  ...
  const handleUpdate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await axios
      .put(`http://localhost:5000/updatefeature/${id}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
          Accept: 'application/json',
        },
      ...
      .then((response) => {
        sweetAlert.fire('Features Updated Successully', '', 'success');
        console.log(response);
        setUdescription('');
        setUtitle('');
      });
  ...
  const handleDelete = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const result = axios
      .delete(`http://localhost:5000/deletefeature/${did}`)
      .then((response) => {
        console.log(response);
        if (response.statusText === 'OK') {
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <form onSubmit={handleUpdate}>
              <div className="p-6.5">
                ...
                <div className="mb-4.5">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Select Icon <span className="text-meta-1">*</span>
                  </label>
                  <input
                    type="file"
                ...
                <div className="mb-4.5">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Features Title <span className="text-meta-1">*</span>
                  </label>
                  <input
                    type="text"
                    value={utitle}
                    ...
                    required
                    placeholder="Update your Features Title"
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                  />
                </div>
                <div className="mb-4.5">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Features Description <span className="text-meta-1">*</span>
                  </label>
                  <textarea
                    rows={2}
                    value={udescription}
                    ...
                    required
                    placeholder="Update Your Features Decription"
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                  />
                </div>
              ...
              <div className="p-6.5">
                ...
                <div className="mb-4.5">
                  ...
                  <input
                    ...
                    required
                    type="text"
                    placeholder="Enter your Features Title"
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                  />
                </div>
                <div className="mb-4.5">
                  ...
                  <textarea
                    ...
                    value={description}
                    required
                    placeholder="Enter Your Features Decription"
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                  />
                </div>
