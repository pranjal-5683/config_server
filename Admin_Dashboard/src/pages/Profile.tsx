    ...
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-0 backdrop-blur sm:h-44 sm:max-w-44 sm:p-0">
            <div className="relative drop-shadow-2">
              
              {image ? <img src={image} alt="profile"  style={{borderRadius:'200px',width:'180px', height:'190px'}} /> : <img src={img} style={{borderRadius:'85px',width:"175px", height:'185px',overflow:'hidden'}} alt="profile" width="50px" /> }
              <label
                htmlFor="profile"
